...
What I think is unique about this library is it's usage / syntax:
  ...
  # => Array of Shippinglogic::FedEx::Track::Event objects
...
In our above example, the call to FedEx was made when we called "tracking.first". That's because it's lazy. It will not make a request to FedEx until absolutely necessary. Once you actually use the object, thats when we call fedex.
