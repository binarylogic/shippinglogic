...
In our above example, you will notice we are able to access attributes, while at the same time able to treat the object as an Array. That's because the object is a Proxy object that is delegating method calls to the underlying array. So it's basically an Array with extra methods.
...
For example of how to use the following service please see the docs for their respective classes.

=== FedEx

1. <b>Tracking</b> - See Shippinglogic::Fedex::Track
2. <b>Getting service rates</b> - See Shippinglogic::Fedex::Rates
